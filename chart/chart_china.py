...
ax = plt.subplot()
plt.title('주간 중국 코로나 상황 (보건복지부 발표기준)')
...
plt.plot([0, 1, 2, 3, 4, 5, 6],[week.w_9_6, week.w_9_5, week.w_9_4, week.w_9_3, week.w_9_2,week.w_9_1,week.w_9_t],c="r",lw="3",ls="--",marker="o",ms="8",mec="blue")
