...
ax = plt.subplot()
plt.title('주간 이란 코로나 상황 (보건복지부 발표기준)')
...
if platform.system() == 'Windows':
# 윈도우인 경우
    world_chart = fig.savefig('./data/confim_iran.png', dpi=fig.dpi)
else:
# 우분투인 경우
    world_chart = fig.savefig('/discord-bot/data/confim_iran.png', dpi=fig.dpi)
