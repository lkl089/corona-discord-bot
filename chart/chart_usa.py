...
ax = plt.subplot()
plt.title('주간 미국 코로나 상황 (보건복지부 발표기준)')
...
plt.plot([0, 1, 2, 3, 4, 5, 6],[week.w_1_6, week.w_1_5, week.w_1_4, week.w_1_3, week.w_1_2,week.w_1_1,week.w_1_t],c="r",lw="3",ls="--",marker="o",ms="8",mec="blue")
