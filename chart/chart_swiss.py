...
ax = plt.subplot()
plt.title('주간 스위스 코로나 상황 (보건복지부 발표기준)')
...
plt.plot([0, 1, 2, 3, 4, 5, 6],[week.w_13_6, week.w_13_5, week.w_13_4, week.w_13_3, week.w_13_2,week.w_13_1,week.w_13_t],c="r",lw="3",ls="--",marker="o",ms="8",mec="blue")
